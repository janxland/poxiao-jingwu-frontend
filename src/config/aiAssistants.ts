...
// 基础URL
const host =
    import.meta.env.VITE_DIFY_HOST ||
...
export const aiPoliceAssistants: AIAssistant[] = [
    {
        ...
        chatUrl: `http://132.232.203.3/chat/LUSWOVQqsMFvDVkh`,
    },
    {
        path: 'case-review',
        name: 'CaseReview',
        title: '案情审查助手',
        description: '输入案情内容，AI将提炼重点和矛盾点',
        chatUrl: `http://132.232.203.3/chat/yzMNJ9NN4eiQ8YuD`,
    },
    {
        ...
        chatUrl: `http://132.232.203.3/chat/gisIkQkhYoetAM9s`,
    },
    {
        path: 'text-review',
        name: 'TextReview',
        ...
        chatUrl: `http://132.232.203.3/chat/QpCycQoA6pZHYFjO`,
    },
    {
        ...
        chatUrl: `http://132.232.203.3/chat/vutbSrCcT4GcMQ5Q`,
    },
    {
        ...
        chatUrl: `http://132.232.203.3/chat/nGaltdlKyq20X0H2`,
    },
    {
        path: 'chat-review',
        name: 'ChatReview',
        ...
        chatUrl: `http://132.232.203.3/chat/6ASeFRhvWobZx4hg`,
    },
    {
        ...
        chatUrl: `http://132.232.203.3/chat/B7oYjk9dW1o55MFW`,
        isFileUpload: true,
    },
    {
        ...
        chatUrl: `http://132.232.203.3/chat/9GjbGtXneUUdczzA`,
        isFileUpload: true,
    },
    {
        ...
        chatUrl: `http://132.232.203.3/chat/X41GZN7TdnR1uuHL`,
        isFileUpload: true,
    },
];
// export const aiPoliceAssistants: AIAssistant[] = [
...
//     title: '星汉智策全能分析助手',
//     description: '输入案情内容，AI将提炼重点和矛盾点',
//     chatUrl: `${host}/chat/cd74hromcQLuYSEm`
//   },
//   {
//     path: 'case-review',
//     name: 'CaseReview',
...
export const chatUrls = {
    // 案件社会活动轨迹分析
    socialActivityUpload:
        aiPoliceAssistants.find((a) => a.path === 'social-activity-assistant')
            ?.chatUrl || '',
    socialActivity:
        aiPoliceAssistants.find((a) => a.path === 'social-activity')?.chatUrl ||
        '',

    // 案件异常资金分析
    financialAnalysis:
        aiPoliceAssistants.find((a) => a.path === 'financial-analysis')
            ?.chatUrl || '',
    financialAnalysisUpload:
        aiPoliceAssistants.find((a) => a.path === 'financial-analysis-tool')
            ?.chatUrl || '',

    // 案情审查
    caseReview:
        aiPoliceAssistants.find((a) => a.path === 'case-review')?.chatUrl || '',

    // 法律咨询
    legalConsultant:
        aiPoliceAssistants.find((a) => a.path === 'legal-consultant')
            ?.chatUrl || '',

    // 通信记录挖掘
    chatReview:
        aiPoliceAssistants.find((a) => a.path === 'chat-review')?.chatUrl || '',
    chatReviewUpload:
        aiPoliceAssistants.find((a) => a.path === 'chat-review-file')
            ?.chatUrl || '',

    // 文件审查
    textReview:
        aiPoliceAssistants.find((a) => a.path === 'text-review')?.chatUrl || '',
};
