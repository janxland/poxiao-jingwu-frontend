        ...
        >
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">
                                <el-tag
                                    :type="
                                        getFileTypeTagType(currentFile.fileType)
                                    "
                                >
            ...
            <template #footer>
                <span class="dialog-footer">
                    <el-button @click="fileDetailVisible = false"
                        >关闭</el-button
                    >
...
import {
    fetchKnowledgeFiles,
    deleteKnowledgeFile,
} from '@/api/modules/knowledgeBase'; // 导入API函数
...
const isJsonContent = computed(() => {
    try {
        if (
            typeof fileContent.value === 'string' &&
            fileContent.value.trim().startsWith('{')
        ) {
